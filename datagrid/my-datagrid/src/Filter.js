...
const Filter = ({mine_filter, ch1h_filter, ch24h_filter, ch7d_filter, name_search}) => {
  ...
  return (
    <div className='wrapper'>
        ...
        <Row className='filter'>
            ...
            <Col xs={1} >
                <Form.Control as="select" style = {{height: '1.5rem', padding: '0.1rem'}} onChange = {handleCh7dFilter}>
                  <option></option>
                  <option>> 0</option>
                </Form.Control>
            </Col>
...
const mapDispatchToProps = (dispatch) => {
  ...
  const {mine_filter, ch1h_filter, ch24h_filter, ch7d_filter, name_search} = bindActionCreators (actions, dispatch);
